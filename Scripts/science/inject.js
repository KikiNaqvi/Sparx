if (!document.getElementById('sparx-cheat-popup')) {
  ...
  document.head.appendChild(fa);
    ...
    wrapper.innerHTML = `
      ...
      ">
        <i class="fa-solid fa-flask fa-2x" style="color: #eee;"></i>
        <img src="https://static.sparx-learning.com/science/75f5e58119e3bd09b7f8f77fb2d860f0dce07631/assets/science_white-DI2HGwcd.svg" style="width: 140px;">
      </div>
      </div>
